...
parser.add_argument("-p", "--plot-method", default="plotly", choices=["plotly", "mpl", "mlab"])
...
for chanel in ["left", "right"]:
    ...
    gg6.save_disc_track(os.path.join(args.directory, "tracks", f"{chanel}.npz"), tracks, disc_id)
